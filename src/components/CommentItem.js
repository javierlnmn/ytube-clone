    ...
    return (
        <div className='my-5 p-5 rounded-md shadow-2xl bg-zinc-700 text-zinc-100 flex flex-col gap-3'>
            ...
            <div className='flex items-center gap-2'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className='w-[20px] h-[20px] fill-gray-100' viewBox="0 0 24 24" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            { comment.snippet.totalReplyCount ? 
                <button onClick={() => showReplies()} className='mr-auto transition-all shadow-md hover:shadow-2xl mt-4 py-1 px-3 bg-teal-600 hover:bg-teal-500 text-zinc-100 rounded-md font-bold'>See replies ({comment.snippet.totalReplyCount} in total) </button> 
